...
export default function AdminSiteForm({ site }: PageProps) {
    ...
    function submit(e: FormEvent) {
        ...
        const filtered = {
            ...
            scraper_config: {
                ...data.scraper_config,
                category_urls: data.scraper_config.category_urls.filter(
                    (u) => u.trim() !== '',
                ),
            },
        };
                        ...
                        <CardContent className="flex flex-col gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Label htmlFor="is_active">
                                    Active (include in scheduled crawls)
                                </Label>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent className="flex flex-col gap-4">
                            <div className="flex flex-col gap-2">
                                ...
                                {data.scraper_config.category_urls.map(
                                    (url, i) => (
                                        <div key={i} className="flex gap-2">
                                            ...
                                            />
                                            {data.scraper_config.category_urls
                                                .length > 1 && (
                                                <Button
                                                    type="button"
                                                    variant="ghost"
